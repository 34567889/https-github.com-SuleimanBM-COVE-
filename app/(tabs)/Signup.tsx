...
import { auth, firestore } from '@/app/firebaseConfig'; // Ensure Firestore is imported
  ...
  const handleSignup = async () => {
    try {
      ...
      try {
        ...
        const userId = response.user.uid; // Get the generated user ID
        ...
        setModalMessage(`Error occurred during signup with Firebase.`);
        setModalVisible(true);
      }
    } catch (error) {
      setModalMessage('Error occurred during signup.');
      setModalVisible(true);
    }
  };
